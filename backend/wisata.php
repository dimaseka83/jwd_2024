...
// The second statement includes a file named "wisataController.php", suggesting that it holds code related to managing data and interactions with a "wisata" entity, possibly part of a broader MVC (Model-View-Controller) architecture for handling requests and data manipulation in a web application.
...
// After that, it creates a new instance of the wisataController class, passing the database connection as a parameter. 
// This suggests that the wisataController class is responsible for handling operations related to the "wisata" entity in the application, such as retrieving, updating, or deleting data from the corresponding database table.
...
// For a GET request, it retrieves all "wisata" data using the getAll method from the wisataController class. 
...
// If the request is a DELETE method, it extracts the 'id' parameter from the query string and invokes the deleteData method from the wisataController class to remove the corresponding data entry. 
